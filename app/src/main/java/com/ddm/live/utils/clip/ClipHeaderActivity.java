package com.ddm.live.utils.clip;
...
public class ClipHeaderActivity extends Activity implements OnTouchListener {
    ...
    private void init() {
        side_length = getIntent().getIntExtra("side_length", 1080);
...
//        bitmap = BitmapUtil.decodeSampledBitmap(path,720,1280);
        bitmap = BitmapUtil.decodeSampledBitmap(path, 1080, 1920);
        ...
        if (bitmap.getWidth() > bitmap.getHeight()) {//宽图
            ...
            scale = (float) srcPic.getWidth() * 2 / 3 / bitmap.getWidth();//宽缩放到imageview的宽的1/2
        }
    ...
    private void generateUriAndReturn() {
        ...
        Log.e("zz", "mSaveUri" + mSaveUri.getPath());
        if (mSaveUri != null) {
