...
public class NewListAdapter extends UltimateViewAdapter<NewListAdapter.SimpleAdapterViewHolder> implements IListLiveView {
...
//    private ProgressBarDialogFragment progressBarDialogFragment;
    ...
    public NewListAdapter(List<StreamsBean> listItems, Context context, AppUser appUser, ImageView headImageBitmap) {
        this.listItems = listItems;
        this.context = context;
...
//                .inflate(R.layout.list_item_weather, parent, false);
                .inflate(R.layout.new_view_adapter, parent, false);
        ViewGroup.LayoutParams params = itemView.getLayoutParams();
        params.height = DensityUtils.getScreenW(context)/2 + DensityUtils.dip2px(context,40);

        itemView.setLayoutParams(params);
       return  new SimpleAdapterViewHolder(itemView, true);
    }
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (!appUser.isLogined()) {
                        ...
                        if (appUser.getId().equals(8) || appUser.getId().equals(18) || appUser.getId().equals(27) || appUser.getId().equals(38)) {
