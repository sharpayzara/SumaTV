 ...
 */
public class LiveSelectListFragment extends BaseFragment implements IListLiveView {
...
//        liveListDialog = DialogUtils.createLoadingDialog(getContext(), "");
        ...
        final View view = inflater.inflate(R.layout.fragment_live_select_list, container, false);
        headImageBitmap = (ImageView) view.findViewById(R.id.headImageBitmap);
        ultimateRecyclerView = (UltimateRecyclerView) view.findViewById(R.id.live_select_list_view);
...
//        ultimateRecyclerView.setRecylerViewBackgroundColor(Color.parseColor("#ffff66ff"));
        ultimateRecyclerView.setDefaultOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                count = simpleRecyclerViewAdapter.getAdapterItemCount();
...
//        Log.d(TAG, "setInfo2List: 这次共加载了条数为" + liveListItems.size());
    ...
    public void onRefreshListEvent(RefreshSelectedListEvent refreshListEvent) {
