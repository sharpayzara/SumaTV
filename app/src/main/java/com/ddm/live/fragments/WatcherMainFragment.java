 ...
 */
public class WatcherMainFragment extends Fragment {
        ...
        viewPager.setAdapter(new FragmentPagerAdapter(getChildFragmentManager()) {
            ...
            public Fragment getItem(int position) {
                if(position == 0){
                    ...
                    watcherLayerFragment =new WatcherLayerFragment();
                    watcherLayerFragment.setArguments(bundle);
//                    watcherLayerFragment.attachView(((VideoPlayerActivity)getActivity()).getLiveViewFragment());
                    watcherLayerFragment.attachView(((VideoPlayerActivity)getActivity()).getLiveViewFragment());
                    return watcherLayerFragment;
                }
                return null;
...
//    }
    ...
    private class MyOnPageChangeListener implements ViewPager.OnPageChangeListener {
        ...
        public void onPageSelected(int position) {
            if(position==0){
//                watcherLayerFragment.hideKeyboard();
            }
        }
        @Override
